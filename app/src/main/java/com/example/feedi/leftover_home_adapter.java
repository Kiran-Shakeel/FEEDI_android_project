...
public class leftover_home_adapter extends ArrayAdapter<leftover_info> {
    Context mcontext;
    int mresourse;


    public leftover_home_adapter(@NonNull Context context, int resource, ArrayList<leftover_info> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        leftover_info info = new leftover_info(id,ins);
