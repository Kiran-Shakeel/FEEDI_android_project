...
public class needy_home_frag extends Fragment implements OnMapReadyCallback {
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            ...
                            if (location != null) {
                                ...
                                try {
                                    ...
                                    mapFragment.getMapAsync(needy_home_frag.this);
                                } catch (IOException e) {
                                    e.printStackTrace();
                                }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Intent intent = new Intent(getActivity(), leftover_list_needy_home.class);
        Bundle b=new Bundle();
