...
public class needy_profile extends AppCompatActivity {
    ...
    private void setProfile() {
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(needy_profile.this, "Error: "+ error, Toast.LENGTH_SHORT).show();
    ...
    {
        Intent intent=new Intent(needy_profile.this,request_list.class);
        startActivity(intent);


    }

    public void leftover_requests(View view)
    {
        Intent intent=new Intent(needy_profile.this,request_list.class);
        intent.putExtra("request_on_leftover_list","yes");
        startActivity(intent);
    ...
    {
        Intent intent=new Intent(needy_profile.this,chat_list.class);
        startActivity(intent);
    }
