...
public class needy_home extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        needy_home_frag frag = new needy_home_frag();
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (item.getItemId() == R.id.nav_profile) {
                intent = new Intent(needy_home.this, needy_profile.class);
                startActivity(intent);
            } else if (item.getItemId() == R.id.nav_settings) {
                intent = new Intent(needy_home.this, settings.class);
                startActivity(intent);
            } else if (item.getItemId() == R.id.nav_review) {
                intent = new Intent(needy_home.this, all_reviews.class);
                startActivity(intent);
                ...
                intent = new Intent(needy_home.this, about_us.class);
                startActivity(intent);
            }
            return true;
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.add) {
            Intent intent = new Intent(needy_home.this, needy_adding_request.class);
            startActivity(intent);
    ...
    private void setProfile() {
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(needy_home.this, "Error: " + error, Toast.LENGTH_SHORT).show();
