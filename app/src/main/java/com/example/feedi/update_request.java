...
public class update_request extends AppCompatActivity {
    ...
    private void setrequest() {
        ...
        request_reference.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                Toast.makeText(update_request.this, "Error: " + error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void post(View view) {
        ...
        if (TextUtils.isEmpty(ins) || TextUtils.isEmpty(member)) {
            Toast.makeText(update_request.this, "All fields must be filled", Toast.LENGTH_SHORT).show();
        } else {
