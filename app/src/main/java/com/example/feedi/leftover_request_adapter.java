...
public class leftover_request_adapter extends ArrayAdapter<leftover_request_info> {

    Context mcontext;
    int mresourse;


    public leftover_request_adapter(@NonNull Context context, int resource, ArrayList<leftover_request_info> Mylist) {
